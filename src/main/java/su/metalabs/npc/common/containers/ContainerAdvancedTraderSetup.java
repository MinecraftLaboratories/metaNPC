...
public class ContainerAdvancedTraderSetup extends MetaContainer {
    ...
    public final RoleAdvancedTrader.Inventory inventoryIn = new RoleAdvancedTrader.Inventory(48, "", "");
    public final RoleAdvancedTrader.Inventory inventoryOut = new RoleAdvancedTrader.Inventory(48, "", "");
    public final RoleAdvancedTrader.Inventory inventoryXp = new RoleAdvancedTrader.Inventory(24, "", "");
    ...
    public ContainerAdvancedTraderSetup(InventoryPlayer inventory, EntityNPCInterface npc) {
        ...
        RoleAdvancedTrader role = (RoleAdvancedTrader) npc.roleInterface;
        ...
        index = 0;
        for (int i = 0; i < 24; ++i) {
            RoleAdvancedTrader.TradeSlot slot = role.getSlot(i);
        ...
        for(int i = 0; i < 24; i++) {
            ...
            if (slot.getSlotXp() != null && slot.getSlotXp().data != null) {
                inventoryXp.setInventorySlotContents((i), slot.getSlotXp().getStackToGM());
            }
        }
    ...
    public void onContainerClosed(EntityPlayer p_75134_1_) {
        ...
        RoleAdvancedTrader role = (RoleAdvancedTrader) this.npc.roleInterface;
        for (int i = 0; i < 3; ++i) {
            for (int j = 0; j < 8; ++j) {
                ItemStack stack = inventoryIn.getStackInSlot(j + (i * 16));
                ItemStack stack2 = inventoryIn.getStackInSlot(j + (i * 16) + 8);
                if (stack != null) {
                    role.getSlot(j + (i * 8)).setSlotIn(0, new RoleAdvancedTrader.TradeSlotIn(new Object[]{RoleAdvancedTrader.TradeType.STACK.ordinal(), stack.copy()}));
                } else
                    role.getSlot(j + (i * 8)).setSlotIn(0, null);
                if (stack2 != null)
                    role.getSlot(j + (i * 8)).setSlotIn(1, new RoleAdvancedTrader.TradeSlotIn(new Object[]{RoleAdvancedTrader.TradeType.STACK.ordinal(), stack2.copy()}));
                else
                ...
                if (stackOut != null)
                    role.getSlot(j + (i * 8)).setSlotOut(0, new RoleAdvancedTrader.TradeSlotOut(new Object[]{RoleAdvancedTrader.TradeType.STACK.ordinal(), stackOut.copy()}));
                else
                    role.getSlot(j + (i * 8)).setSlotOut(0, null);
                if (stackOut2 != null)
                    role.getSlot(j + (i * 8)).setSlotOut(1, new RoleAdvancedTrader.TradeSlotOut(new Object[]{RoleAdvancedTrader.TradeType.STACK.ordinal(), stackOut2.copy()}));
                else
                    role.getSlot(j + (i * 8)).setSlotOut(1, null);

                ItemStack stackXp = inventoryXp.getStackInSlot(j + (i * 8));
                if(stackXp != null) {
                    role.getSlot(j + (i * 8)).setSlotXp(new RoleAdvancedTrader.TradeSlotXp(new Object[]{RoleAdvancedTrader.TradeType.XP.ordinal(), stackXp.copy()}));
                } else {
